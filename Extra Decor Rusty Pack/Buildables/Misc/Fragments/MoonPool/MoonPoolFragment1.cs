...
{
    public static class BuildableMoonPoolFragment1
    {
        public static string modFolder = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
        public static string iconPath = Path.Combine(modFolder, "Assets", "Fragments", "MoonPool", "MoonPool1.png");
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("BuildableMoonPoolFragment1", "MoonPool Fragment 1", "MoonPool fragment from Aurora's wreckages. Please return to the Alterra Corporation immediately.")
        ...
        public static void Register()
        {
            ...
            CloneTemplate MoonPoolClone = new CloneTemplate(Info, "30189aca-d5b5-4363-8398-11d6a109addb");

            MoonPoolClone.ModifyPrefab += obj =>
            {
                ConstructableFlags constructableFlagsInsideOutside = ConstructableFlags.Outside | ConstructableFlags.Inside | ConstructableFlags.Rotatable | ConstructableFlags.Ground | ConstructableFlags.AllowedOnConstructable;

                GameObject MoonPoolModel = obj.transform.Find("Moon_Pool_fragment_01").gameObject;
