...
{
    public static class BuildableCyclopsBridgeFragment2
    {
        public static string modFolder = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
        public static string iconPath = Path.Combine(modFolder, "Assets", "Fragments", "Cyclops", "Bridge2.png");
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("BuildableCyclopsFragmentBridge2", "Cyclops Bridge Fragment 2", "Cyclops bridge fragment from Aurora's wreckages. Please return to the Alterra Corporation immediately.")
        ...
        public static void Register()
        {
            ...
            CloneTemplate CyclopsFragmentClone = new CloneTemplate(Info, "72d0460c-1b50-416b-8a9d-58e415132d3d");
