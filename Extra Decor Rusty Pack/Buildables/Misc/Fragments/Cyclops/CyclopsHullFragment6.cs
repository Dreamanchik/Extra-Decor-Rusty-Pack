...
{
    public static class BuildableCyclopsHullFragment6
    {
        public static string modFolder = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
        public static string iconPath = Path.Combine(modFolder, "Assets", "Fragments", "Cyclops", "Hull6.png");
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("BuildableCyclopsFragmentHull6", "Cyclops Hull Fragment 6", "Cyclops hull fragment from Aurora's wreckages. Please return to the Alterra Corporation immediately.")
        ...
        public static void Register()
        {
            ...
            CloneTemplate CyclopsFragmentClone = new CloneTemplate(Info, "d5f3a601-729e-407a-b229-fd3daa601dd3");
