...
{
    public static class BuildableLifePod13Exploded
    {
        public static string modFolder = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
        public static string iconPath = Path.Combine(modFolder, "Assets", "Lifepods", "Lifepod13.png");
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("BuildableLifePod13Exploded", "Life Pod 13 Exploded", "Alterra escape pod from the Aurora. Highly damaged")
