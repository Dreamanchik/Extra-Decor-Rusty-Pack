...
{
    public static class BuildableLifePod6Exploded
    {
        public static string modFolder = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
        public static string iconPath = Path.Combine(modFolder, "Assets", "Lifepods", "Lifepod6.png");
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("BuildableLifePod6Exploded", "Life Pod 6 Exploded", "Alterra escape pod from the Aurora. Highly damaged")
        ...
        public static void Register()
        {
            ...
            CloneTemplate LifePodExplodedClone = new CloneTemplate(Info, "85ae70e0-176c-4de6-8c4d-48c4f504cc79");
